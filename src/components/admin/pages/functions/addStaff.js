...
function AddStaff(){
    ...
    const handleFinish = (values) => {
        ...
        console.log('this is birhtday: ', dateBirthday);
    ...
    function onChange(date, dateString) {
        ...
        console.log('birthday: ', dateBirthday);
    ...
    return (        
        <div>
            <Space direction="vertical">    
                <Button shape="round" type="primary" size="large" onClick={showModal}><UserAddOutlined></UserAddOutlined>Add</Button>  
            </Space>
            <Modal title="Add Staff" visible={visible} footer={[
                <Modal footer={null}/>
            ]}>
